...
const envSchema = z.object({
  ...
  OPENAI_BASE_URL: z.string().url().default("https://ai-api.cuhk.edu.cn/v1"),
  OPENAI_TEXT_API_KEY: z.string().default(""),
  OPENAI_TEXT_BASE_URL: z.string().url().default("https://ai-api.cuhk.edu.cn/v1"),
  OPENAI_TEXT_MODEL: z.string().default("qwen3-5-397b-a17b"),
  OPENAI_VISION_API_KEY: z.string().default(""),
  OPENAI_VISION_BASE_URL: z.string().url().default("https://ai-api.cuhk.edu.cn/v1"),
  OPENAI_VISION_MODEL: z.string().default("qwen3-5-397b-a17b"),
  SCHOLARSHIP_CHECK_AI_API_KEY: z.string().default(""),
  SCHOLARSHIP_CHECK_AI_BASE_URL: z.string().url().default("https://ai-api.cuhk.edu.cn/v1"),
  SCHOLARSHIP_CHECK_AI_MODEL: z.string().default("qwen3-5-397b-a17b"),
